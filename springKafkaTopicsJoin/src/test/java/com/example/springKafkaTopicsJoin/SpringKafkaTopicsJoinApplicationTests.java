package com.example.springKafkaTopicsJoin;
...
@Profile("test")
@Testcontainers
@SpringBootTest(classes = SpringKafkaTopicsJoinApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class SpringKafkaTopicsJoinApplicationTests {
    ...
    static void registerKafkaProperties(@NotNull DynamicPropertyRegistry registry) {
